...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    p(a("Switzerland",href="http://en.wikipedia.org/wiki/Switzerland")," is a country in the middle of europe. It's seperated into 26 cantons. In Switzerland the 4 official languages are German, French, Italien and Romansh."),
